...
if( $Phone !="" && $National_ID !="" )
{
    ...
    $Data=SELECT_BY_QUARY("SELECT National_Id,Phone,Enabled,Done_User_Id FROM User INNER JOIN User_Types ON User.User_Type=User_Types.Id WHERE User.Phone='$Phone' AND User.National_Id='$National_ID' AND Enabled=1;","National_Id~Phone~Enabled~Done_User_Id","1");
