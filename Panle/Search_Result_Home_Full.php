        ...
        <label class="full-input-New-Home">
            <center>
                ...
                <?php
                    ...
                    $Users=$_REQUEST['Home_ID'];
                    $Users=SELECT_BY_QUARY("SELECT User.Id AS Id,User.User_Image AS Image FROM History INNER JOIN User ON History.User_Id=User.Id WHERE Home_Id=$Search","Id~Image","1");
                ...
                <div class="Home_History">
                    ...
                    for($i=1;$i<count($Users);$i++)
                    {
                        ...
                        $DT=preg_split("/\~/",$Users[$i]);

                        ?>

                        <a href="User_Ditales.php?User_ID=<?php echo $DT[0];?>"><img src="../uploads/User/<?php echo $DT[1]; ?>"
                                                                   class="Profile_Pictures"></a>
